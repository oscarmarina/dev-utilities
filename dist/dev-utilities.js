...
function* l(t, e = 0, n = () => !0, s = () => !1) {
  ...
  const o = (
    ...
    t instanceof HTMLElement && t.shadowRoot ? t.shadowRoot.children : t instanceof HTMLSlotElement ? t.assignedNodes({ flatten: !0 }) : t.childNodes
  );
  for (const i of o)
    yield* l(i, e, n, s);
}
...
function* m(t) {
  for (let e = t; e; ) {
    const n = (
      // eslint-disable-next-line no-nested-ternary
      e instanceof HTMLElement && e.assignedSlot ? e.assignedSlot : e instanceof ShadowRoot ? e.host : e.parentNode
    );
    n && (yield n), e = n;
  }
}
